...
public class UserTileRef extends TileRef {
	private String userID;
	
	public UserTileRef(TileserverImage image, int rset, int x, int y, String userID) {
		super(image, rset, x, y);
		this.userID = userID;
	}
	...
	public String getKey() {
		return this.userID + "/" + super.getKey();
	}
}
