...
/**
 * XML WMS Request for GetMap
 * @author lobugliop
 *
 */
public class XmlGetMapRequest130 extends XmlWMSRequest<GetMapType> implements GetMapRequest {
   private static final Logger LOGGER = LoggerFactory.getLogger(XmlGetMapRequest130.class);
    ...
    * @param request
    */
   public XmlGetMapRequest130(GetMapType request) {
      super(request);
      requestHandler = new GetMapRequestHandler();
   }

   /**
    * Get layer names of request
    */
   ...
   @Override
   /**
    * Uses GetMapRequestHandler to produce the map chip as a response
    */
