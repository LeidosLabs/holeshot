...
public class UriInfoGetCapabilitiesRequest111 extends UriInfoWMSRequest implements GetCapabilitiesRequest {
   private static final Logger LOGGER = LoggerFactory.getLogger(UriInfoGetCapabilitiesRequest111.class);

   private final GetCapabilitiesRequestHandler111 requestHandler;

   public UriInfoGetCapabilitiesRequest111(UriInfo info) {
      super(info);
