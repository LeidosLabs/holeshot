 ...
 */
public class ImageSegmentMetadataSerializer extends JsonSerializer<ImageSegment> {
   private static final Logger LOGGER = LoggerFactory.getLogger(ImageSegmentMetadataSerializer.class);
  ...
  @Override
  public void serialize(ImageSegment imageSegment,
