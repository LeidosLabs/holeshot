...
import com.leidoslabs.holeshot.imaging.RenderedTilePyramid;
...
public class LocalNITFFilePyramid extends RenderedTilePyramid {

  private ParseStrategy parseStrategy;

  public LocalNITFFilePyramid(File nitfFile) throws IOException, NitfFormatException {

    FileInputStream inputStream = new FileInputStream(new File("/Users/parrise/Environment/data/po_154871_rgb_0000000.ntf"));
    parseStrategy = new SlottedParseStrategy();
