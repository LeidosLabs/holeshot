...
import static org.lwjgl.opengl.GLX.GLX_ACCUM_ALPHA_SIZE;
import static org.lwjgl.opengl.GLX.GLX_ACCUM_BLUE_SIZE;
import static org.lwjgl.opengl.GLX.GLX_ACCUM_GREEN_SIZE;
import static org.lwjgl.opengl.GLX.GLX_ACCUM_RED_SIZE;
import static org.lwjgl.opengl.GLX.GLX_ALPHA_SIZE;
...
import static org.lwjgl.opengl.GLX.GLX_STENCIL_SIZE;
import static org.lwjgl.opengl.GLX.GLX_STEREO;
...
import static org.lwjgl.opengl.GLXARBContextFlushControl.GLX_CONTEXT_RELEASE_BEHAVIOR_ARB;
import static org.lwjgl.opengl.GLXARBContextFlushControl.GLX_CONTEXT_RELEASE_BEHAVIOR_FLUSH_ARB;
import static org.lwjgl.opengl.GLXARBContextFlushControl.GLX_CONTEXT_RELEASE_BEHAVIOR_NONE_ARB;
import static org.lwjgl.opengl.GLXARBCreateContext.GLX_CONTEXT_DEBUG_BIT_ARB;
import static org.lwjgl.opengl.GLXARBCreateContext.GLX_CONTEXT_FLAGS_ARB;
import static org.lwjgl.opengl.GLXARBCreateContext.GLX_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB;
import static org.lwjgl.opengl.GLXARBCreateContext.GLX_CONTEXT_MAJOR_VERSION_ARB;
import static org.lwjgl.opengl.GLXARBCreateContext.GLX_CONTEXT_MINOR_VERSION_ARB;
import static org.lwjgl.opengl.GLXARBCreateContext.glXCreateContextAttribsARB;
import static org.lwjgl.opengl.GLXARBCreateContextNoError.GLX_CONTEXT_OPENGL_NO_ERROR_ARB;
import static org.lwjgl.opengl.GLXARBCreateContextProfile.GLX_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB;
import static org.lwjgl.opengl.GLXARBCreateContextProfile.GLX_CONTEXT_CORE_PROFILE_BIT_ARB;
import static org.lwjgl.opengl.GLXARBCreateContextProfile.GLX_CONTEXT_PROFILE_MASK_ARB;
import static org.lwjgl.opengl.GLXARBCreateContextRobustness.GLX_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB;
import static org.lwjgl.opengl.GLXARBCreateContextRobustness.GLX_CONTEXT_ROBUST_ACCESS_BIT_ARB;
import static org.lwjgl.opengl.GLXARBCreateContextRobustness.GLX_LOSE_CONTEXT_ON_RESET_ARB;
import static org.lwjgl.opengl.GLXARBMultisample.GLX_SAMPLES_ARB;
import static org.lwjgl.opengl.GLXARBMultisample.GLX_SAMPLE_BUFFERS_ARB;
import static org.lwjgl.opengl.GLXARBRobustnessApplicationIsolation.GLX_CONTEXT_RESET_ISOLATION_BIT_ARB;
import static org.lwjgl.opengl.GLXEXTCreateContextES2Profile.GLX_CONTEXT_ES2_PROFILE_BIT_EXT;
import static org.lwjgl.opengl.GLXEXTFramebufferSRGB.GLX_FRAMEBUFFER_SRGB_CAPABLE_EXT;
import static org.lwjgl.opengl.GLXNVDelayBeforeSwap.glXDelayBeforeSwapNV;
import static org.lwjgl.opengl.GLXNVMultisampleCoverage.GLX_COLOR_SAMPLES_NV;
 ...
 * @author Joshua Slack
 */
public class PlatformLinuxGLCanvas extends AbstractPlatformGLCanvas {
