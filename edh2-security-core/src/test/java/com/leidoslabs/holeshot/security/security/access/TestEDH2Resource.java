...
public class TestEDH2Resource implements FullEDH2Group {
  ...
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_IDENTIFIER)
  private String identifier;
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_CREATE_DATE_TIME)
  private Date createDateTime;
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_RESPONSIBLE_ENTITY)
  private final Set<String> responsibleEntity = new TreeSet<>();
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_DATA_SET)
  private final Set<String> dataSet = new TreeSet<>();
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_AUTH_REF)
  private final Set<String> authRef = new TreeSet<>();
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_POLICY_REF)
  private final Set<String> policyRef = new TreeSet<>();
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_POLICY)
  private final Set<PolicyRule> policyRules = new TreeSet<>();
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_CONTROL_SET)
  private final Set<String> controlSet = new TreeSet<>();
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_IS_EXTERNAL)
  private Boolean isExternalEDH = null;
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_IS_RESOURCE)
  private Boolean isResourceEDH = null;
  @JsonProperty(EDH2Constants.EDH_PREFIX + EDH2Constants.EDH_SPECIFICATION)
