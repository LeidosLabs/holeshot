 ...
 * /com/google/common/primitives/UnsignedBytes.java and
...
public class LexicographicalComparerHolder {
  ...
  private final static Logger logger = LoggerFactory.getLogger(LexicographicalComparerHolder.class);
  /**
   * <p>
   * compareBytes.</p>
   *
   * @param kvbuffer an array of byte.
   * @param offset1 a int.
   * @param keyLen1 a int.
   * @param kvbuffer2 an array of byte.
   * @param offset2 a int.
   * @param keyLen2 a int.
   * @return a int.
   */
  ...
  static Comparer<byte[]> getBestComparer() {
    try {
      ...
      logger.error("Loading lexicographicalComparerJavaImpl...",t);
              ...
              .doPrivileged(new PrivilegedAction<Object>() {
                ...
                public Object run() {
                  try {
                    ...
                    logger.error("Unable to access theUnsafe");
