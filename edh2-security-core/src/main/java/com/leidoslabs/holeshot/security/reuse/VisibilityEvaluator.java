...
public class VisibilityEvaluator {
  ...
  static Authorizations escape(Authorizations auths) {
    List<byte[]> retAuths = new ArrayList<>(auths.getAuthorizations().size());
   ...
   * @throws VisibilityParseException if
   * an AND or OR subexpression has less than two children, or a subexpression
