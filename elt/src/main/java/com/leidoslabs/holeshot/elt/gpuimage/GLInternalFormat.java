...
//   GlInternalFormatRGB8UI(3, 8, GL_RGB8UI, GL_RGB_INTEGER, GL_UNSIGNED_INT),
   ...
   GlInternalFormatRGB8(3, 8, GL_RGB, GL_RGB, GL_UNSIGNED_BYTE),

// GlInternalFormatRGB16UI(3, 16, GL_RGB16UI, GL_RGB_INTEGER, GL_UNSIGNED_SHORT),
   GlInternalFormatRGB16UI(3, 16, GL_RGB32F, GL_RGB, GL_UNSIGNED_SHORT),

   GlInternalFormatRGB32UI(3, 32, GL_RGB32UI, GL_RGB, GL_UNSIGNED_INT),

   GlInternalFormatRGB32F(3, 32, GL_RGB32F, GL_RGB, GL_FLOAT),

   // 4 - Bands
   GlInternalFormatRGBA8(4, 8, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE),
   GlInternalFormatRGBA16UI(4, 16, GL_RGBA32F, GL_RGBA, GL_UNSIGNED_SHORT),
   GlInternalFormatRGBA32UI(4, 32, GL_RGBA32UI, GL_RGBA, GL_UNSIGNED_INT),
