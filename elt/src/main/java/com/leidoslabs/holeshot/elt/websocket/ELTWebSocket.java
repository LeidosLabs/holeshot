...
public class ELTWebSocket {
   ...
   public static void sendImageLoad(String appId, String imageURL) {
       String tileserver = "tileserver.leidoslabs.com";
       String replaceMe = String.format("https://%s/tileserver/", tileserver);
       String imageId = imageURL.replace(replaceMe, "").replaceAll("/", ":");
       Map<String, String> properties= new HashMap<String, String>();
   ...
   private static void sendEvent(String appId, WebSocketEvent event) {
       ...
       try {
           Iterator<Session> appSubscriberIterator = sessionMap.get(appId).iterator();
