 ...
 */
package com.leidoslabs.holeshot.elt.basemap;
 ...
 *
 */
public abstract class Basemap extends Renderer<Void> {

	/**
	 * @param imageWorld
	 * @param eltDisplayContext
	 */
	public Basemap(ImageWorld imageWorld, ELTDisplayContext eltDisplayContext) {
